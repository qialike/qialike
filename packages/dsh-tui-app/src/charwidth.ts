 ...
 *
 * @module @yourname/dsh-tui-app/charwidth
 */
...
function cacheFile(): string {
  ...
  return join(dir, 'dsh-tui-charwidth.json')
}
...
export function initCharWidthCalibration(opts: CharWidthHooks): void {
  if (!process.stdout.isTTY || !process.stdin.isTTY || process.env.DSH_TUI_NO_CALIBRATION === '1') {
